...
/// The most common two are declaring a variable binding, and using a `;` with an expressios:
///
...
/// such as a local variable. However, if the last expression of the block ends with
