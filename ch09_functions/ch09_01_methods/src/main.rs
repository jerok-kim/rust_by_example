...
/// associated functions, and methods. Associated functions are functions that are defined
/// on a type generally, while methods are associated function that are called on
