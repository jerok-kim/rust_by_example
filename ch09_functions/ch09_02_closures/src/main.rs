...
/// Calling a closure is exactly like calling a function. However, both input and return types
/// can be inferred and input variable names must be specified.
///
...
fn main() {
    ...
    // Once closures'1 type has been inferred,
    // it cannot be inferred again with another type.
