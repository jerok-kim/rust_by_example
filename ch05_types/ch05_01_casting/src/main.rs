...
fn main() {
    ...
    println!("1000 binary {:b}", 1000);
    println!(" 232 binary   {:b}", 232);
    ...
    // 128 as u8 -> 128, whose value in 8-bit two's complement representation
    ...
    // If the floating point value exceeds the upper bound or is less than the lower bound,
